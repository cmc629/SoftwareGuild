...
public class FunctionCallAlphabet {
    ...
    public static void main( String[] args ) {
        ...
        f("Funky");    // displays the word you pass it beginning with "F"
        ...
        n("Numbing");    // displays the word you pass it beginning with "N"
        ...
        t("Terrestrial");    // displays the word you pass it beginning with "T"
