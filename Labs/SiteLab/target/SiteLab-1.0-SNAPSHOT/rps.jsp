        ...
        <div class="container">
            ...
            <form action="RPSServlet" method="POST">
                ...
                <p>
                    ...
                    <input type="submit" class="btn btn-primary" name="rock" value="Rock">
                    <input type="submit" class="btn btn-primary" name="paper" value="Paper">
                    <input type="submit" class="btn btn-primary" name="scissors" value="Scissors">
                </p>
